...
public class AutomationTestPlanThree {

	public Xls_Reader xls;
	public WebDriver driver;
	public boolean skipTestCase = false;

	public AutomationTestPlanThree() {
		this.xls = new Xls_Reader(FrameworkConstants.PS_DATA_XLS_PATH);

	}

	public AutomationTestPlanThree(Xls_Reader xls) {
		this.xls = xls;
	}
...
//		    TestReportsLog.startTest(test.testName(), test.description());
		...
		//			driver.get(ReadProperties.getConfigProp().getProperty("hubUrl"));
