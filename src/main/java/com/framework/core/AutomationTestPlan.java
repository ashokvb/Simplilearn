...
public abstract class AutomationTestPlan {

	public Xls_Reader xls;
	public WebDriver driver;
	public boolean skipTestCase = false;
	
	public AutomationTestPlan() {
		
	}
	public AutomationTestPlan(Xls_Reader xls) {
		this.xls = xls;
	}
	...
	public void beforeTestMethod(final Object[] parameters, final Method method, final ITestContext testContex,
			final XmlTest xmlTest) throws InterruptedException {
		...
		if (method != null) {
			...
			if (!browser.contentEquals("Null")) {
				...
				if (!browser.isEmpty()) {
                    ...
                    driver.get(ReadProperties.getConfigProp().getProperty("url"));
