...
import com.framework.base.constants.TestType;

//import com.framework.base.constants.TestType;

import com.framework.util.XMLUtility;
...
public class SeleniumTestsContextManager {
    ...
    public static SeleniumTestsContext getThreadContext() {
        if (threadLocalContext.get() == null) {
            ...
            //ITestContext iTestContext=getContextFromConfigFile(new DefaultTestNGContext());
